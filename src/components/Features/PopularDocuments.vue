          ...
          <div class="rounded overflow-hidden mb-2">
            ...
            <div class="bg-secondary p-4">
              <div class="d-flex justify-content-between mb-3">
                <small class="m-0"
                  ><i class="fa fa-users text-primary mr-2"></i>25 Lượt
                  đọc</small
                >
                <small class="m-0"
              ...
              <a class="h5" href=""
                >Khóa học thiết kế và phát triển web cho người mới bắt đầu</a
              >
              <div class="border-top mt-4 pt-4">
                <div class="d-flex justify-content-between">
                  ...
                  <h5 class="m-0">Tác giả Nguyễn Văn A</h5>
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      subjects: [
        { name: "Web Design", courses: "100", img: "img/cat-1.jpg", link: "#" },
        {
          name: "Development",
          courses: "100",
          img: "img/cat-2.jpg",
        ...
        { name: "Marketing", courses: "100", img: "img/cat-5.jpg", link: "#" },
        { name: "Research", courses: "100", img: "img/cat-6.jpg", link: "#" },
        {
        ...
        { name: "SEO", courses: "100", img: "img/cat-8.jpg", link: "#" },
      ],
    };
  },
};
