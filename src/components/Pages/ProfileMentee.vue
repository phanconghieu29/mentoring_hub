            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#experience">Kinh nghiệm</a>
                        </li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#education">Giáo dục</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#awards">Thành tựu</a></li>
                    </ul>
                </div>
            </nav>
            <!-- Page Content-->
                ...
                <section class="resume-section" id="experience">
                    <div class="resume-section-content">
                        ...
                        <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                            ...
                            <div class="flex-shrink-0"><span class="text-primary">December 2011 - March 2013</span>
                            </div>
                        </div>
                        <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                            <div class="flex-grow-1">
                                ...
                                <p>Podcasting operational change management inside of workflows to establish a
                                    ...
                                    Keeping
                                    your eye on the ball while performing a deep dive on the start-up mentality to
                                    derive
                        ...
                        <div class="d-flex flex-column flex-md-row justify-content-between">
                            ...
                            <div class="flex-shrink-0"><span class="text-primary">September 2008 - June 2010</span>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section class="resume-section" id="interests">
                    <div class="resume-section-content">
                        ...
                        <p>Apart from being a web developer, I enjoy most of my time being outdoors. In the winter, I am
                            an
                            avid skier and novice ice climber. During the warmer months here in Colorado, I enjoy
                            mountain
...
<style scoped>
@import "../../assets/css/ProfileMentee.css";
.navbar {
  z-index: 998; 
